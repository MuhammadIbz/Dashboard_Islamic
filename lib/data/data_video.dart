const List<Map<String, String>> videos = [
  {
    'thumbnail': 'assets/images/thumbnail_video_kajian_1.jpg',
    'account': 'Khalid Basalamah Official',
    'ustadz': 'Ustadz Khalid Basalamah',
    'title': 'Berbakti kepada Orang Tua',
    'url': 'https://www.youtube.com/watch?v=QQsJ5GuiFhM',
    "description":
        "Orang tua adalah pintu surga kita, maka maksimalkanlah untuk mengejar ridha Alloh Subhanahu Wa Ta'ala selama orang tua kita masih hidup. Berbuat baiklah kepada kedua orang tua mu, dan jangan pernah berperilaku buruk kepada mereka. Berbakti kepada orang tua termasuk amalan yang paling Alloh cintai setelah Sholat pada waktunya. Raihlah kedua orang tuamu, jadikanlah mereka sebagai ajang untuk masuk ke dalam surga dan mendapat ridha Alloh Subhanahu Wa Ta'ala. Amin."
            'Jika Allah memberikan kita harta, maka tunjukkanlah bahwa Allah memberikan harta kepada kita, artinya berpakaianlah yang baik bukan karena sombong.'
  },
  {
    'thumbnail': 'assets/images/thumbnail_video_kajian_2.jpg',
    'account': 'Firanda Andirja',
    'ustadz': 'Ustadz Dr. Firanda Andirja, M.A.',
    'title': 'Bentuk Syukur',
    'url': 'https://www.youtube.com/watch?v=poeEN1XVGk4',
    'description':
  ...
  {
    'thumbnail': 'assets/images/thumbnail_video_kajian_3.jpg',
    'account': 'Yufid.TV',
    'ustadz': 'Ustadz Abdurrahman Thoyib, Lc',
    'title': 'Tujuan Hidup',
    'url': 'https://www.youtube.com/watch?v=nFr1Jj1KxVk',
    'description':
  ...
  {
    'thumbnail': 'assets/images/thumbnail_video_kajian_4.jpg',
    'account': 'Rodja TV',
    'ustadz': 'Ustadz Abu Fairuz Ahmad Ridwan, M.A.',
    'title': 'Bentuk Syukur',
    'url': 'https://www.youtube.com/watch?v=ui74ovJ6tSU',
    'description':
  ...
  {
    'thumbnail': 'assets/images/thumbnail_video_kajian_5.jpg',
    'account': 'Rumaysho',
    'ustadz': 'Ustadz M Abduh Tuasikal',
    'title': 'Jangan Buang-Buang Waktu',
    'url': 'https://www.youtube.com/watch?v=xzovFDz2ul8',
    'description':
